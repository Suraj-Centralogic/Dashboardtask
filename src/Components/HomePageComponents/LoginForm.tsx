...
import { Paper, Typography, Button, Checkbox, FormControlLabel, Box, Link, Divider } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      <Box component="form" onSubmit={formik.handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
        <CustomTextField label="Email" name="email" formik={formik} startAdornment={<EmailIcon sx={{ color: 'grey.500' }} />} />
